...
const Navbar = () => {
  ...
  return (
    <div className="absolute flex justify-center w-full mx-auto bottom-4">
      <div className="px-2 bg-gray-800 shadow-lg rounded-2xl">
        <div className="flex">
          <div className="flex-1 group">
            <a className="flex items-end justify-center w-full px-2 pt-2 mx-auto text-center group-hover:text-indigo-400">
              <span className="block px-1 pt-1 pb-1">
                <span className="block pb-1 ">Home</span>
                <span className="block w-5 h-1 mx-auto rounded-full group-hover:bg-indigo-300"></span>
              </span>
            </a>
          </div>
          <div className="flex-1 group">
